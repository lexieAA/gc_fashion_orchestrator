...
//	@CrossOrigin(origins = "http://localhost:8080")
	...
	@CrossOrigin(origins = "http://localhost:8080")
	@GetMapping(path = "/shop/transactions/{id}")
	public ResponseEntity<String> getTransactionById(@PathVariable Long id) {
		return restTemplate.getForEntity("http://localhost:" + ONLINE_SERVICE + "/gcfashions/shop/transactions/" + id,
				String.class);
	}
	...
	public ResponseEntity<String> getCartByUserId(@PathVariable Long userId) {
		return restTemplate.getForEntity(
				"http://localhost:" + ONLINE_SERVICE + "/gcfashions/shop/transactions/cart/userid/" + userId,
				String.class);
	}
	...
	public void updateTransaction(@RequestBody Transaction t) {
		restTemplate.put("http://localhost:" + ONLINE_SERVICE + "/gcfashions/shop/transactions", t, String.class);
	}
	...
	public void updateTransactionCost(@RequestBody Map<String, Object> values) {
		restTemplate.put("http://localhost:" + ONLINE_SERVICE + "/gcfashions/shop/checkout", values, String.class);
	}
	...
	public ResponseEntity<String> createTransaction(@RequestBody Transaction t) {
		return restTemplate.postForEntity("http://localhost:" + ONLINE_SERVICE + "/gcfashions/shop/transactions", t,
				String.class);
	}
	...
	public ResponseEntity<String> addCouponByUserId(@RequestBody Transaction t) {
		try {
			return restTemplate.postForEntity(
					"http://localhost:" + ONLINE_SERVICE + "/gcfashions/shop/transactions/open/coupon", t,
					String.class);
		} catch (Exception e) {
	...
	public ResponseEntity<String> createPaymentIntent(@RequestBody Transaction t) {
		return restTemplate.postForEntity("http://localhost:" + ONLINE_SERVICE + "/gcfashions/shop/checkout", t,
				String.class);
	}
	...
	public void deleteTransaction(@PathVariable Long id) {
		restTemplate.delete("http://localhost:" + ONLINE_SERVICE + "/gcfashions/shop/transactions/" + id, String.class);
	}
	...
	public void removeFromOpenTransactionByUserId(@PathVariable Long userId, @PathVariable Long sku) {
		restTemplate.delete("http://localhost:" + ONLINE_SERVICE + "/gcfashions/shop/transactions/open/userid/" + userId
				+ "/sku/" + sku, String.class);
	}
