...
//	@CrossOrigin(origins = "http://localhost:8080")
	...
	@CrossOrigin(origins = "http://localhost:8080")
	@GetMapping(path = "/sales/transactions/open/userid/{userId}")
	public ResponseEntity<String> getOpenTransactionByUserId(@PathVariable Long userId) {
		return restTemplate.getForEntity(
				"http://localhost:" + SALES_SERVICE + "/gcfashions/sales/transactions/open/userid/" + userId,
				String.class);
	}

	// read list of items in cart by userId
	@CrossOrigin(origins = "http://localhost:8080")
	@GetMapping(path = "/sales/transactions/cart/userid/{userId}")
	public ResponseEntity<String> getCartByUserId(@PathVariable Long userId) {
		return restTemplate.getForEntity(
				"http://localhost:" + SALES_SERVICE + "/gcfashions/sales/transactions/cart/userid/" + userId,
				String.class);
	}
	...
	public ResponseEntity<String> getCouponByUserId(@PathVariable Long userId) {
		return restTemplate.getForEntity(
				"http://localhost:" + SALES_SERVICE + "/gcfashions/sales/transactions/open/coupon/userid/" + userId,
				String.class);
	}
	...
	// update a transaction
	@CrossOrigin(origins = "http://localhost:8080")
	@PutMapping(path = "/sales/checkout")
	public void updateTransactionCost(@RequestBody Map<String, Object> values) {
		restTemplate.put("http://localhost:" + SALES_SERVICE + "/gcfashions/sales/checkout", values, String.class);
	}
	...
	public ResponseEntity<String> addCouponByUserId(@RequestBody Transaction t) {
		try {
			return restTemplate.postForEntity(
					"http://localhost:" + SALES_SERVICE + "/gcfashions/sales/transactions/open/coupon", t,
					String.class);
		} catch (Exception e) {
	...
	// the transaction
	@CrossOrigin(origins = "http://localhost:8080")
	@PostMapping(path = "/sales/checkout")
	public ResponseEntity<String> createPaymentIntent(@RequestBody Transaction t) {
		return restTemplate.postForEntity("http://localhost:" + SALES_SERVICE + "/gcfashions/sales/checkout", t,
				String.class);
	}
	...
	public void removeFromOpenTransactionByUserId(@PathVariable Long userId, @PathVariable Long sku) {
		restTemplate.delete("http://localhost:" + SALES_SERVICE + "/gcfashions/sales/transactions/open/userid/" + userId
